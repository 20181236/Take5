...
public class UiStat : MonoBehaviour
{
    ...
    void UpdateUiText()
    {
        ...
        displayText4.text = Stat.instance.money.ToString();
        displayText5.text = Stat.instance.army.ToString();
        displayText6.text = Stat.instance.faith.ToString();
        displayText7.text = Stat.instance.science.ToString();
        displayText8.text = Stat.instance.politics.ToString();
